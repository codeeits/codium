...
export class Settings {
    ...
    public highlightBorderColor: string;
    public doneColor: string;
    public speed: number;

    constructor(highlightColor = "oklch(0.7 0.1 225)",
                highlightBorderColor = "oklch(0.6765 0.1998 42.35)",
                doneColor = "oklch(0.6813 0.1915 132.7732)",
                speed = 1) {
