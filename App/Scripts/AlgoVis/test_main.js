...
for (let i = 0; i < n; i++) {
    ...
    let container = new Container(size_X, size_y, i * (root.width / n), 4* root.height / 5 - size_y, template);
...
PrefabAnimations.MERGE_SORT_ANIMATION(vector, compare, scheduleRender, {highlightColor: "", highlightBorderColor: "", speed: 2})
