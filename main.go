...
func main() {
	...
	// Serve static files from the "App" directory at the "/app/" URL path
	{
		...
		mux.Handle("/app/", cfg.HeaderSettingsMiddleware(http.StripPrefix("/app/", http.FileServer(http.Dir("./App/")))))
		...
		mux.Handle("GET /admin/lessons/suggested", cfg.HeaderSettingsMiddleware(cfg.AuthenticatedEndpointMiddleware(cfg.GetSuggestedLessonsHandler)))
		mux.Handle("POST /admin/lessons/suggested/{lessonID}/approve", cfg.AuthenticatedEndpointMiddleware(cfg.ApproveLessonHandler))
		mux.Handle("GET /admin/problems/suggested", cfg.HeaderSettingsMiddleware(cfg.AuthenticatedEndpointMiddleware(cfg.GetSuggestedProblemsHandler)))
		...
		mux.Handle("GET /api/users", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUsersHandler)))
		mux.Handle("GET /api/users/{searchArg}", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserHandler)))
		mux.Handle("GET /api/users/gdpr", cfg.HeaderSettingsMiddleware(cfg.AuthenticatedEndpointMiddleware(cfg.GetAllUserDataHandler)))
		mux.Handle("GET /api/email/{userID}", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.ValidateEmailHandler)))
		...
		mux.Handle("GET /api/lessons", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetLessonDisambiguationHandler)))
		...
		mux.Handle("GET /api/lessons/{lessonID}/users/{userID}", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetLessonUserByLessonAndUserHandler)))
		// Deprecated endpoint for bookmarks
		mux.Handle("GET /api/users/{userID}/bookmarks", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserBookmarksHandler)))

		mux.Handle("GET /api/users/{userID}/bookmarked_lessons", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserBookmarksHandler)))
		mux.Handle("GET /api/lessons/{lessonID}/faves", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetFavoritesForLessonHandler)))
		mux.Handle("GET /api/users/{userID}/started_lessons", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserStartedLessonsHandler)))
		mux.Handle("GET /api/users/{userID}/completed_lessons", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserCompletedLessonsHandler)))
		mux.Handle("GET /api/users/{userID}/interactions", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserInteractionsHandler)))

		mux.Handle("POST /api/problems", cfg.AuthenticatedEndpointMiddleware(cfg.CreateProblemHandler))
		mux.Handle("GET /api/problems", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetProblemsDisambiguationHandler)))
		...
		mux.Handle("GET /api/problems/{problemID}/users/{userID}", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetUserProblemByUserAndProblemHandler)))
		mux.Handle("GET /api/users/{userID}/bookmarked_problems", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetBookmarkedProblemsHandler)))
		mux.Handle("GET /api/users/{userID}/solved_problems", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetSolvedProblemsHandler)))
		mux.Handle("GET /api/problems/{problemID}/likes", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetLikedProblemsHandler)))
		...
		mux.Handle("GET /api/tests/{testID}", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.GetProblemTestByIDHandler)))
		...
		mux.Handle("GET /api/solutions", cfg.HeaderSettingsMiddleware(cfg.AuthenticatedEndpointMiddleware(cfg.GetSolutionsDisambiguationHandler)))

		mux.Handle("GET /api/users/{userID}/started_lessons/count", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.CountUserStartedLessonsHandler)))
		mux.Handle("GET /api/users/{userID}/completed_lessons/count", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.CountUserCompletedLessonsHandler)))
		mux.Handle("GET /api/users/{userID}/bookmarks/count", cfg.HeaderSettingsMiddleware(http.HandlerFunc(cfg.CountUserBookmarkedLessonsHandler)))
		mux.Handle("GET /api/solutions/count", cfg.HeaderSettingsMiddleware(cfg.AuthenticatedEndpointMiddleware(cfg.CountSolutionsDisambiguationHandler)))
